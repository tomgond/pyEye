...
import os
import random
from utils.constants import PROJECT_HOME, ML_PATH

os.path.join(PROJECT_HOME, )

upper_body= cv2.CascadeClassifier(os.path.join(ML_PATH, 'haar_classifiers', 'haarcascade_mcs_upperbody.xml'))
frontal2 = cv2.CascadeClassifier(os.path.join(ML_PATH, 'haar_classifiers', 'haarcascade_frontalface_alt2.xml'))
frontaldefault = cv2.CascadeClassifier(os.path.join(ML_PATH, 'haar_classifiers', 'haarcascade_frontalface_default.xml'))
mouth = cv2.CascadeClassifier(os.path.join(ML_PATH, 'haar_classifiers', 'haarcascade_mcs_mouth.xml'))
left_eye = cv2.CascadeClassifier(os.path.join(ML_PATH, 'haar_classifiers', 'haarcascade_mcs_lefteye.xml'))
